...
I brough few improvements to Felix' implementation but before reading the following I recommend you to read carefully [the original post](https://felixge.de/2017/07/27/implementing-state-machines-in-postgresql.html).
